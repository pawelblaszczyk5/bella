...
const serve = async ({ request }: { request: Request }) => {
	...
	originUrl.searchParams.set("table", '"userExperienceEvaluation"');
...
export const ServerRoute = createServerFileRoute("/api/user-experience-evaluations").methods({ GET: serve });
